...
@section('content')
    <div class="container">
        <form method="post" class="form-group" action="{{route('edit-blog', $blog->id)}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{$blog->title}}" placeholder="Title" name="title" type="text">
                                    ...
                                    <div class="form-group">
                                        <img src="{{asset('images/blog/'.$blog->image)}}" width="250px" alt="">
                                    </div>
                                    <div class="form-group">
